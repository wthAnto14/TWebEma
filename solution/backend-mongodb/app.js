...
const swaggerOptions = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Anime Portal API - MongoDB Server',
      version: '1.0.0',
      description: 'Backend server connected to MongoDB for handling user data, ratings, and reviews',
    },
    servers: [
      {
        url: 'http://localhost:3001',
        description: 'MongoDB Backend Server',
      },
    ],
  },
